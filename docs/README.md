...
Runbooks: `docs/runbooks/` (gồm `nba-service-recovery.md`, `platform-apex-demo.md` cho apex Platform + demo.).
Platform apex (Haravan-like): kế hoạch §9p trong `04_Ke_hoach_Trien_khai_WebCom_v1.md`.
