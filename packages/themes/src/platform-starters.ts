    ...
    content: {
      ...
      sections: {
        announce: {
          ...
          id: 'sec_announce',
          props: {
            text: 'Điều hành theo contribution margin — không chỉ GMV',
            cta_label: 'Đặt demo',
            href: '/#demo',
        ...
        hero: {
          ...
          props: {
            ...
            sub: 'Website, Social, Live, POS và sàn trên một OS. Đo contribution margin, không chỉ GMV.',
            primary_cta: {
              label: 'Đặt demo',
              href: '/#demo',
              cta_code: 'cta_book_demo',
        ...
        proof: {
          ...
          props: {
            items: [
              ...
              { n: '5+', label: 'Kênh bán đồng bộ realtime' },
              { n: '15+', label: 'Nhà vận chuyển & COD' },
              { n: '12+', label: 'Cổng thanh toán / QR' },
            ],
          },
          style: {},
        },
            ...
            items: [
              {
                ...
                body: 'Theme đo CVR · Brand Kit · Go-live gate',
                href: '/templates?goal=conversion',
                icon: 'cart',
              },
              {
                title: 'Live & Social',
                body: 'Keyword order · attribution · margin sau show',
        ...
        cta: {
          ...
          id: 'sec_cta',
          props: {
            headline: 'Đặt demo 30 phút theo ngành',
            body: 'Tour Command Center, Go-live và Social/Live — so sánh margin vs chỉ nhìn GMV.',
            cta: { label: 'Đặt demo', href: '/#demo', cta_code: 'cta_book_demo' },
          },
          style: {},
        },
      },
