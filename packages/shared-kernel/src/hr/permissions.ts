...
export const HR_PERMISSIONS = [
  ...
  'website.edit',
  'website.publish',
  // Platform CMS (corporate / GTM) — CORP-CMS-0
  'platform.cms.read',
  'platform.cms.write',
...
const DESCRIPTIONS: Record<HrPermission, string> = {
  ...
  'platform.cms.read': 'Đọc Platform CMS (corporate pages)',
  'platform.cms.write': 'Sửa draft Platform CMS — không publish',
  'platform.cms.publish': 'Duyệt / publish Platform CMS (Approver)',
